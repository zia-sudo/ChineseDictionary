...
namespace ChineseDictionary
{
    public class HelpCommand
    {
        public void Execute()
        {
            ...
            Console.WriteLine("3. getpinyin      - Recherche le pinyin d'un mot chinois.");
            Console.WriteLine("4. getsimplified  - Recherche la forme simplifiée d'un mot chinois.");
            Console.WriteLine("5. gettraditional - Recherche la forme traditionnelle d'un mot chinois.");
            Console.WriteLine("6. gettranslation - Recherche la traduction d'un mot chinois en français.");
